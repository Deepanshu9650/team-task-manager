    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                background: 'rgba(167,139,250,0.15)', borderRadius: '50%',
                top: '-100px', left: '-100px', filter: 'blur(80px)', pointerEvents: 'none'
            }} />
            <div style={{
                position: 'absolute', width: '400px', height: '400px',
                background: 'rgba(96,165,250,0.15)', borderRadius: '50%',
                bottom: '-100px', right: '-100px', filter: 'blur(80px)', pointerEvents: 'none'
            }} />
            <div style={{
                position: 'absolute', width: '300px', height: '300px',
                background: 'rgba(245,87,108,0.1)', borderRadius: '50%',
            ...
            <div style={{
                ...
                {error && (
                    <div style={{
                        ...
                        fontWeight: '600', marginBottom: '1.5rem', textAlign: 'center'
                    }}>⚠️ {error}</div>
                )}
                ...
                {activeTab === 'signup' && (
                    <form onSubmit={handleSignup}>
                        ...
                        <button type="submit" disabled={loading} style={{
                            ...
                            fontSize: '1rem', fontWeight: '700',
                            cursor: loading ? 'not-allowed' : 'pointer',
                            boxShadow: loading ? 'none' : '0 10px 30px rgba(56,239,125,0.3)',
                            transition: 'all 0.2s'
                        }}
                            onMouseEnter={e => { if (!loading) e.target.style.transform = 'translateY(-2px)'; }}
                            onMouseLeave={e => { e.target.style.transform = 'translateY(0)'; }}
